    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="mx-auto flex w-full max-w-sm flex-col items-center gap-8 px-4">
        <div className="flex flex-col items-center gap-2 text-center">
          <h1 className="text-2xl font-bold tracking-tight">Promptmeter</h1>
          <p className="text-muted-foreground">Know what your AI costs.</p>
        </div>
        ...
        <div className="flex w-full flex-col gap-3">
          <Button
            ...
            onClick={() => {
              // TODO: NextAuth.js signIn("google")
          ...
          <Button
            ...
            className="w-full justify-center gap-2"
            onClick={() => {
              // TODO: NextAuth.js signIn("github")
